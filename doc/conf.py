# -*- coding: utf-8 -*-
#
# bose documentation build configuration file, created by
...
from bose import __versioninfo__ as bose_version
bose_version = tuple(str(x) for x in bose_version)
...
version = '.'.join(bose_version[:2])
# The full version, including alpha/beta/rc tags.
release = '.'.join(bose_version[:3])
...
latex_documents = [
  ('index', 'bose.tex', ur'bose Documentation',
