# -*- coding: utf-8 -*-
#
# psychoacoustics documentation build configuration file, created by
...
from psychoacoustics import __versioninfo__ as psychoacoustics_version
psychoacoustics_version = tuple(str(x) for x in psychoacoustics_version)
...
version = '.'.join(psychoacoustics_version[:2])
# The full version, including alpha/beta/rc tags.
release = '.'.join(psychoacoustics_version[:3])
...
html_style = 'psychoacoustics.css'
...
htmlhelp_basename = 'psychoacousticsdoc'
...
latex_documents = [
  ('index', 'psychoacoustics.tex', ur'psychoacoustics Documentation',
