...
class Xunit(Plugin):
    ...
    def options(self, parser, env):
        ...
        parser.add_option(
            ...
            default=env.get('BOSE_XUNIT_FILE', 'bosetests.xml'),
        ...
        parser.add_option(
            ...
            default=env.get('BOSE_XUNIT_TESTSUITE_NAME', 'bosetests'),
        ...
        parser.add_option(
            ...
            default=bool(env.get('BOSE_XUNIT_PREFIX_WITH_TESTSUITE_NAME', False)),
