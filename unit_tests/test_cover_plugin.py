    ...
    def test_cover_options_config_file(self):
        ...
        try:
            c1, c2 = _test_options_helper(
                ...
                env_key='PSY_ECHOS_TICKS_COVER_CONFIG_FILE')
