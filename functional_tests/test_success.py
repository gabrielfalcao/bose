import os
import unittest
from psychoacoustics.plugins.plugintest import PluginTester, remove_timings
...
class TestSingleTestPass(PluginTester, unittest.TestCase):
    ...
    def test_single_test_pass(self):
        # note that this doesn't use psychoacoustics.plugins.doctests.run, in order that
