...
implementing :meth:`begin() <psychoacoustics.plugins.base.IPluginInterface.begin>`.
...
that implements :meth:`begin() <psychoacoustics.plugins.base.IPluginInterface.begin>`
