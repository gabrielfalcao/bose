...
def setup():
    psychoacoustics_parent_dir = os.path.normpath(os.path.join(os.path.abspath(os.path.dirname(psychoacoustics.__file__)),'..'))
    paths = [psychoacoustics_parent_dir]
    if PYTHONPATH:
...
runner = os.path.join(support, 'fake_psychoacousticstest.py')
