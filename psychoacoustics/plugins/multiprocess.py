...
class MultiProcess(Plugin):
    ...
    def options(self, parser, env):
        ...
        parser.add_option("--processes", action="store",
                          default=env.get('PSY_ECHOS_TICKS_PROCESSES', 0),
                          ...
                          "testing. Default is 0 unless PSY_ECHOS_TICKS_PROCESSES is "
                          "set. "
                          "[PSY_ECHOS_TICKS_PROCESSES]")
        parser.add_option("--process-timeout", action="store",
                          default=env.get('PSY_ECHOS_TICKS_PROCESS_TIMEOUT', 10),
                          dest="multiprocess_timeout",
                          metavar="SECONDS",
                          help="Set timeout for return of results from each "
                          "test runner process. Default is 10. "
                          "[PSY_ECHOS_TICKS_PROCESS_TIMEOUT]")
        parser.add_option("--process-restartworker", action="store_true",
                          default=env.get('PSY_ECHOS_TICKS_PROCESS_RESTARTWORKER', False),
