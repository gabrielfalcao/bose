...
And by default a file named psytests.xml will be written to the
working directory.
...
Here is an abbreviated version of what an XML test report might look like::
    ...
    <testsuite name="psytests" tests="1" errors="1" failures="0" skip="0">
...
class Xunit(Plugin):
    ...
    def options(self, parser, env):
        ...
        parser.add_option(
            ...
            default=env.get('PSY_ECHOS_TICKS_XUNIT_FILE', 'psytests.xml'),
            help=("Path to xml file to store the xunit report in. "
                  "Default is psytests.xml in the working directory "
                  "[PSY_ECHOS_TICKS_XUNIT_FILE]"))

        parser.add_option(
            '--xunit-testsuite-name', action='store',
            dest='xunit_testsuite_name', metavar="PACKAGE",
            default=env.get('PSY_ECHOS_TICKS_XUNIT_TESTSUITE_NAME', 'psytests'),
